...
urlpatterns = [
    ...
    path('<int:pk>/inscribir/', views.inscribir_alumno, name='inscribir_alumno'),
    path('alumno/<int:alumno_pk>/eliminar_inscripcion/<int:clase_pk>/', views.eliminar_inscripcion, name='eliminar_inscripcion'),
