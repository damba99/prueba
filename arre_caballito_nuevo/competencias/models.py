...
class Inscripcion_competencia(models.Model):
    ...
    id_competencia = models.ForeignKey(Competencia, related_name='inscripciones_competencia', on_delete=models.CASCADE)
    id_alumno = models.ForeignKey(Alumno, related_name='inscripciones_competencia', on_delete=models.CASCADE)
    id_caballo = models.ForeignKey(Caballo, related_name='inscripciones_competencia', on_delete=models.CASCADE, null=True, blank=True)
    id_evento = models.ForeignKey(Evento, related_name='inscripciones_competencia', on_delete=models.CASCADE)
